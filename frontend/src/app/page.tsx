  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[85vh] text-center px-4 overflow-hidden">
      ...
      <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000 zoom-in-95 ease-out max-w-4xl mx-auto flex flex-col items-center">
        {/* Badge */}
        <div className="glass px-4 py-1.5 rounded-full inline-flex items-center gap-2 mb-8 text-sm text-indigo-300 font-medium tracking-wide">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          ...
          <Link 
            href="/login" 
            className="w-full sm:w-auto glass text-zinc-300 font-semibold px-8 py-4 rounded-xl hover:bg-white/10 hover:text-white transition-all duration-300 flex items-center justify-center"
          >
            Sign In
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-24 max-w-5xl w-full animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300 fill-mode-both">
        <div className="glass-card p-6 flex flex-col items-center text-center">
          ...
          <h3 className="text-lg font-semibold text-white mb-2">Project Workspaces</h3>
          <p className="text-zinc-400 text-sm">Organize your initiatives into dedicated, clean workspaces.</p>
        </div>
        ...
        <div className="glass-card p-6 flex flex-col items-center text-center">
          ...
          <p className="text-zinc-400 text-sm">Securely manage Admin, Manager, and Team Member permissions.</p>
        </div>
        ...
        <div className="glass-card p-6 flex flex-col items-center text-center">
          ...
          <p className="text-zinc-400 text-sm">Monitor task statuses in real-time with stunning visualizations.</p>
        </div>
      </div>
    </div>
  );
